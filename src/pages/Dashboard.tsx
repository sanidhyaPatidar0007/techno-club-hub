        ...
        <main className={`pt-24 transition-all duration-300 ${sidebarExpanded ? 'ml-64' : 'ml-20'}`}>
          <div className="container mx-auto px-6 py-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
              ...
              >
                <h1 className="text-3xl font-bold">Welcome back, Jason</h1>
                <p className="text-muted-foreground mt-1">Here's what's happening with your tech clubs today.</p>
              </motion.div>
                      ...
                      {upcomingEvents.map((event, index) => (
                        <div key={index} className="flex items-start">
                          <div className="flex-shrink-0 w-12 text-center">
                            <div className="font-bold text-lg text-primary">{event.day}</div>
                ...
                <Card className="h-full">
                  ...
                  <CardContent>
                    ...
                    <div className="mt-6 pt-6 border-t">
                      <h4 className="text-sm font-medium mb-3">Your Credits</h4>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      <CardDescription>Latest shared documents and files</CardDescription>
                    </div>
                    <Button variant="outline" size="sm" asChild>
              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Your upcoming to-dos</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {tasks.map((task, index) => (
                        <div key={index} className="flex items-start">
                          <div className="flex-shrink-0 pt-1">
                            <div className={`w-4 h-4 rounded-full border-2 ${task.status === 'completed' ? 'bg-green-500 border-green-500' : 'border-gray-300'}`}></div>
                          </div>
                          <div className="ml-3">
