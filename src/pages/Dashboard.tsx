...
const Dashboard = () => {
  ...
  return (
    <PageLayout 
      ...
      description="Here's what's happening with your tech clubs today."
      backgroundImage="https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=10"
